        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-300">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setIsOverlayOpen(true)}
                className="rounded-full border border-white/10 px-3 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-slate-200"
              >
                Fullscreen
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/95 p-4">
          ...
          <div className="w-full max-w-4xl h-[86vh] bg-black">
            <iframe
              ...
              referrerPolicy="no-referrer"
              allow="autoplay; fullscreen; encrypted-media; picture-in-picture"
              title={`${title} season ${selectedSeasonNumber} episode ${selectedEpisodeNumber} - fullscreen`}
            />
          </div>
        </div>
      )}
